module m64k_core_system_control_tb;
    ...
    always_ff @(posedge clk) begin
        if (!rst_n)
            ...
            cycles <= cycles + 1;
            if (cycles > 4000)
                $fatal(1, "M64K system-control test timed out");
        end
    end
    ...
    initial begin
        ...
        set_data_long(M64K_VECTOR_ILLEGAL * 4, 32'h0000_0180);
        ...
        set_data_long(M64K_VECTOR_TRAP_BASE * 4, 32'h0000_0180);
        ...
        set_data_long(M64K_VECTOR_TRACE * 4, 32'h0000_0180);
