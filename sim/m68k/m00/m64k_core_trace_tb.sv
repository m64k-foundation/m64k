module m64k_core_trace_tb;
    ...
    always_ff @(posedge clk) begin
        if (!rst_n) begin
            ...
            if (cycles > 5000)
                $fatal(1, "M64K trace test timed out");
        end
    end
    ...
    initial begin
        ...
        set_long(M64K_VECTOR_TRACE * 4, 32'h0000_0180);
        set_long((M64K_VECTOR_AUTOVECTOR_BASE + 6) * 4, 32'h0000_01a0);
        ...
        set_long(M64K_VECTOR_TRACE * 4, 32'h0000_01a0);
        set_long(M64K_VECTOR_TRAP_BASE * 4, 32'h0000_0180);
