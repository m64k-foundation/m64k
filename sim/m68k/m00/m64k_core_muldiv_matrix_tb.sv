module m64k_core_muldiv_matrix_tb;
    import m64k_pkg::*;
    ...
    function automatic logic [7:0] operation_id(input integer operation);
        case (operation)
            0: return M64K_INSN_MULU;
            1: return M64K_INSN_MULS;
            2: return M64K_INSN_DIVU;
            default: return M64K_INSN_DIVS;
        endcase
    endfunction
        ...
        begin
            ...
            case (operation)
                0: begin
                    ...
                    expected_sr[M64K_SR_N] = result[31];
                    expected_sr[M64K_SR_Z] = (result == 0);
                end
                1: begin
                ...
                2: begin
                    ...
                    expected_sr[M64K_SR_N] = unsigned_quotient[15];
                    expected_sr[M64K_SR_Z] = (unsigned_quotient == 0);
                end
                default: begin
                    ...
                    expected_sr[M64K_SR_N] = signed_quotient[15];
                    expected_sr[M64K_SR_Z] = (signed_quotient == 0);
                end
            endcase
        end
    endtask
