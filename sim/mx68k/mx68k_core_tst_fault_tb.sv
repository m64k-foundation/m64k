module mx68k_core_tst_fault_tb;
    ...
    always_ff @(posedge clk) begin
        if (!rst_n)
            ...
            cycles <= cycles + 1;
            if (cycles > 3000)
                $fatal(1, "TST read-fault test timed out");
        end
    end
    ...
    initial begin
        ...
        set_instruction_word(16'h10a, 16'h4a18); // TST.B (A0)+
