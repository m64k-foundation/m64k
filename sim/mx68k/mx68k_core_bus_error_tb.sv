module mx68k_core_bus_error_tb;
    ...
    always_ff @(posedge clk) begin
        if (!rst_n) begin
            ...
            if (cycles > 5000)
                $fatal(1, "MX68K bus/address-error test timed out");
        end
    end
    ...
    initial begin
        ...
        set_long(MX_VECTOR_ACCESS_FAULT * 4, 32'h0000_0180);
        ...
        set_long(MX_VECTOR_ADDRESS_ERROR * 4, 32'h0000_01a0);
        ...
        set_long(MX_VECTOR_ACCESS_FAULT * 4, 32'h0000_01c0);
