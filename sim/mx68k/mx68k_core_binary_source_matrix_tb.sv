module mx68k_core_binary_source_matrix_tb;
    import mx68k_pkg::*;
    ...
    function automatic logic [7:0] operation_id(input integer operation,
        ...
        case (operation)
            0: return 8'(MX_INSN_ADD_B + size_index);
            1: begin
                case (size_index)
                    0: return MX_INSN_SUB_B;
                    1: return MX_INSN_SUB_W;
                    default: return MX_INSN_SUB_L;
                endcase
            end
            2: begin
                case (size_index)
                    0: return MX_INSN_AND_B;
                    1: return MX_INSN_AND_W;
                    default: return MX_INSN_AND_L;
                endcase
            end
            3: return 8'(MX_INSN_OR_B + size_index);
            default: begin
                case (size_index)
                    0: return MX_INSN_CMP_B;
                    1: return MX_INSN_CMP_W;
                    default: return MX_INSN_CMP_L;
                endcase
            end
        endcase
    endfunction
