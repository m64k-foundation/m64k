module mx68k_register_file_tb;
    ...
    initial begin
        ...
        commit_cycle();
        assert (!sr[MX_SR_S] && address_read_value_b == 32'h0000_8000);
        ...
        commit_cycle();
        assert (sr[MX_SR_S] && address_read_value_b == 32'h0010_0000);
