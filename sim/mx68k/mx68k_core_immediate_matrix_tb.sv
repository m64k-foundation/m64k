module mx68k_core_immediate_matrix_tb;
    import mx68k_pkg::*;
    ...
    function automatic logic [7:0] operation_id(input integer operation);
        case (operation)
            0: return MX_INSN_ORI;
            1: return MX_INSN_ANDI;
            2: return MX_INSN_SUBI;
            3: return MX_INSN_ADDI;
            4: return MX_INSN_EORI;
            default: return MX_INSN_CMPI;
        endcase
    endfunction
