module mx68k_core_address_arithmetic_matrix_tb;
    import mx68k_pkg::*;
    ...
    function automatic logic [7:0] operation_id(input integer operation,
                                                 input integer size_index);
        case (operation)
            0: return size_index ? MX_INSN_ADDA_L : MX_INSN_ADDA_W;
            1: return size_index ? MX_INSN_SUBA_L : MX_INSN_SUBA_W;
            default: return size_index ? MX_INSN_CMPA_L : MX_INSN_CMPA_W;
        endcase
    endfunction
    ...
    function automatic logic [15:0] compare_sr(
        ...
        begin
            ...
            value[MX_SR_Z] = (result == 0);
            value[MX_SR_V] = (destination[31] != source[31]) &&
                             (result[31] != destination[31]);
            value[MX_SR_C] = (destination < source);
            return value;
        end
    endfunction
