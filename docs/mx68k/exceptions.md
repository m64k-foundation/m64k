# MX68K exceptions, traps and interrupts
...
All producer stages report the typed `mx_exception_t` record from
`rtl/mx68k/core/mx68k_arch_pkg.sv`. It preserves both instruction-start and
...
The shared vector constants live in `mx68k_arch_pkg.sv`: reset vectors 0/1,
...
remain reserved unless a named MX extension assigns them.
