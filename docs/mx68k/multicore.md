# MX68K multicore boot and ISA boundary
...
Every core has an independent `mx68k_irq_if`. The interrupt controller selects
...
instruction may reduce idle power and latency, but it is an optional MXMP
...
Established Motorola encodings and semantics take priority. MXA/MXMP opcodes
