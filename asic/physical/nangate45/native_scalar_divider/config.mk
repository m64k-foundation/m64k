export DESIGN_NICKNAME = m64k_native_scalar_divider
export DESIGN_NAME = m64k_scalar_divider
export PLATFORM = nangate45

export VERILOG_FILES = \
    /workspace/rtl/packages/m64k_arch_types_pkg.sv \
    /workspace/rtl/core/execute/common/m64k_execute_backend_pkg.sv \
    /workspace/rtl/core/execute/divide/m64k_scalar_divider_pkg.sv \
    /workspace/rtl/core/execute/divide/m64k_scalar_divider.sv

export SYNTH_HDL_FRONTEND = slang
export SDC_FILE = /workspace/asic/physical/nangate45/native_scalar_divider/constraints.sdc
...
override export KLAYOUT_TECH_FILE = /workspace/build/asic/physical/native_scalar_divider/m64k-FreePDK45.lyt
