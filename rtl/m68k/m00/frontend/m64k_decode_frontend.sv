module m64k_decode_frontend #(
    ...
    output m64k_uop_pkg::m64k_uop_t instruction_uop,
    output m64k_arch_pkg::m64k_exception_t instruction_exception,
    ...
    m64k_mem_fault_t fetch_word_fault;
    ...
    logic consume_valid;
    logic consume_ready;
    m64k_arch_pkg::m64k_profile_t stream_profile_q;
    ...
    m64k_instruction_buffer #(.DEPTH_WORDS(QUEUE_WORDS)) instruction_buffer (
        .clk, .rst_n,
    ...
    m64k_predecoder #(.WINDOW_WORDS(QUEUE_WORDS)) predecoder (
    ...
    always_ff @(posedge clk) begin
        if (!rst_n) begin
            ...
            stream_profile_q <= m64k_arch_pkg::M64K_PROFILE_M00;
        end else begin
            if (redirect_valid)
