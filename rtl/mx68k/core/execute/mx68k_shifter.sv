module mx68k_shifter (
    input  logic [31:0] operand,
    input  mx68k_arch_pkg::mx_operand_size_t size,
    ...
    output mx68k_arch_pkg::mx_alu_result_t shift_result
);
    ...
    always_comb begin
        ...
        rotated_ring = 33'd0;
        case (size)
            MX_OP_BYTE: ring_mask = 33'h0000_01ff;
            MX_OP_WORD: ring_mask = 33'h0001_ffff;
